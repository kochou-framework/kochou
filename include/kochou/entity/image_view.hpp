...
public:
    ...
    // fabrics
public:
    static ktl::result< std::vector< kochou::entity::shared_image_view >, ktl::errc >
    make(kochou::shared_context _sctx, std::span< kochou::entity::shared_image > _shared_images,
         ktl::api::format                 _format,
         ktl::api::image_aspect_flag_bits _aspect = ktl::api::image_aspect_flag_bits::v_color_bit) noexcept;

    // common
public:
    image_view(kochou::shared_context _sctx, kochou::entity::shared_image _shared_image,
...
private:
    ...
    kochou::entity::shared_image image_;
};
} // namespace kochou::entity
